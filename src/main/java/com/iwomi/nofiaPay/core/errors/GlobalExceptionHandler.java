...
import com.iwomi.nofiaPay.core.errors.exceptions.*;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorObject> handleGeneralException(GeneralException ex, WebRequest request) {
    ...
    @ExceptionHandler(PendingValidationException.class)
    public ResponseEntity<ErrorObject> handlePendingValidationException(PendingValidationException ex, WebRequest request) {
        ErrorObject errorObject = new ErrorObject();
